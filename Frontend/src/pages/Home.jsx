...
function Home() {
  ...
  // Update request set when data changes
  useEffect(() => {
    if (!Array.isArray(outgoingFriendReq)) return;
    const ids = new Set(outgoingFriendReq.map((req) => req.recipient));
    setOutgoingRequestId(ids);
  }, [outgoingFriendReq]);
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto space-y-10">
        ...
        {loadingFriends ? (
          ...
          <div className="grid grid-col-1 sm:grid-cols-2 lg:grid-col-3 xl:grid-col-4 gap-4">
          ...
          {loadingRecommend ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                const hasRequestBeenSent = outgoingRequestId.has(user._id);
